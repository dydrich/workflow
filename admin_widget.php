...
<div class="welcome">
	...
	<p class="w_text" style="margin-top: 10px">
		<a href="richieste.php?idw=1" class="<?php if ($permessi_giornalieri_doc > 0) echo "attention" ?>">Permessi giornalieri: <?php echo $permessi_giornalieri_doc ?></a>
	</p>
	<p class="w_text" style="margin: 0">
		<a href="richieste.php?idw=2" class="<?php if ($permessi_orari_doc > 0) echo "attention" ?>">Permessi orari: <?php echo $permessi_orari_doc ?></a>
	</p>
</div>
<div class="welcome">
	<p id="w_head" style="margin-bottom: 0; background-image: none">
	...
	<p class="w_text" style="margin-top: 10px">
		<a href="richieste.php?idw=3" class="<?php if ($permessi_giornalieri_ata > 0) echo "attention" ?>">Permessi giornalieri: <?php echo $permessi_giornalieri_ata ?></a>
	</p>
	<p class="w_text" style="margin-top: 0">
		<a href="richieste.php?idw=4" class="<?php if ($permessi_orari_ata > 0) echo "attention" ?>">Permessi orari: <?php echo $permessi_orari_ata ?></a>
	</p>
</div>
