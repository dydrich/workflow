	...
	<script type="text/javascript">
        $(function(){
            ...
            $('.upd_req').on('click', function (event) {
                ...
                if (status === 'open') {
                    document.location.href = "permesso_orario.php?idr="+idr;
                }
            });
                ...
                complete: function(data){
                    ...
                    if (json.status == "kosql"){
                        ...
                        window.setTimeout(function () {
                            window.document.location = "permesso_orario.php?idr="+json.requestID;
                        }, 2500);
                    }
                }
            });
				...
				while ($row = $res_perms->fetch_assoc()) {
					...
					<div class="card" id="row<?php echo $row['id_richiesta'] ?>" style="<?php if($state === 'closed') echo "background-color: #EEEEEE"; ?>">
						...
						<div class="card_minicontent">
                            ...
                            <div>
                                Ore richieste: <span class="_bold"><?php echo $row['intero1'] ?></span>
                            </div>
                            <div style="margin-top: 15px; margin-bottom: 5px">
                                Codice pratica: <?php echo $row['codice_pratica'] ?>
                                <div style="float: right; margin-right: 20px; color: #1E4389">
