...
<head>
	...
	<title><?php print $_SESSION['__config__']['intestazione_scuola'] ?>:: ufficio</title>
	...
	<script>
        ...
        var registra = function () {
            ...
            $.ajax({
                type: "POST",
                url: url,
                data: {nome: $('#new_off').val(), action: <?php echo $action ?>, id: <?php echo $_REQUEST['id'] ?>},
                dataType: 'json',
                error: function() {
                ...
                complete: function(data){
                    ...
                    if (json.status == "kosql"){
                        ...
                        window.setTimeout(function () {
                            document.location.href = "offices.php";
                        }, 2500);
                    }
                }
            });
	...
	<div id="left_col">
		<form id="my_form" method="post" style="margin-top: 30px; text-align: left; width: 460px; margin-left: auto; margin-right: auto">
			<table style="width: 400px; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: 5px">
				<tr>
					<td style="width: 60%">
						<label for="new_off">Ufficio</label>
					</td>
					<td style="width: 40%">
                        <input type="text" name="new_off" id="new_off" style="width: 250px; font-size: 11px" value="<?php if(isset($ufficio)) echo $ufficio['nome'] ?>" />
                    </td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
