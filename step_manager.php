...
switch($_POST['action']){
	case 1:     // inserimento
		$statement = "INSERT INTO w_step (descrizione, ufficio) VALUES ('".$nome."', $ufficio)";
		$msg = "Lo step &egrave; stato inserito correttamente";
		break;
	case 2:     // cancellazione
		$statement = "DELETE FROM w_step WHERE id_step = ".$_POST['_i'];
		//print $statement;
		$msg = "Lo step &egrave; stato cancellato correttamente";
		break;
	case 3:     // modifica
		$statement = "UPDATE w_step SET descrizione = '$nome', ufficio = $ufficio WHERE id_step = ".$_POST['_i'];
		//print $statement;
