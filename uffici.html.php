...
<body <?php if(isset($_REQUEST['msg'])){ ?>onload="openInfoDialog(messages[<?php print $_REQUEST['msg'] ?>], 2)"<?php } ?>>
    ...
    <form>
        <table class="admin_table">
            ...
            <tr class="admin_row">
                <td style="width: 20%" class="adm_titolo_elenco">ID ufficio</td>
                <td style="width: 80%; padding-left: 20px" class="adm_titolo_elenco">Ufficio</td>
            </tr>
            <tr class="admin_row">
                <td colspan="2"></td>
            </tr>
            ...
            <tr class="admin_row<?php if($x % 2) print(" odd") ?>">
                <td style="padding-left: 5px;<?php if($x % 2) print("background-color: #E7E7E7") ?>"><?php print $ufficio['id_ufficio'] ?></td>
                <td style="padding-left: 20px; color: #003366<?php if($x % 2) print(';background-color: #E7E7E7') ?>"><span id="row<?php print $ufficio['id_ufficio'] ?>"><a href="#" onclick="change(this, 'row<?php print $ufficio['id_ufficio'] ?>')"><?php print $ufficio['nome'] ?></a></span></td>
            </tr>
            <?php 
				$x++;
			} 
